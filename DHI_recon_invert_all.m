...
date = date_ref(1:6);
directory_save = ['/Users/apple/Documents/ZaPHD/DHI',date]; % directory_save = ['H:\Reconstructions\',date,'\inverted'];
mkdir(['/Users/apple/Documents/ZaPHD/DHI',date]); % mkdir(['H:\Reconstructions\',date],'inverted');
